...
- **index_codebase** - Index Python projects with graph analysis
- **get_project_stats** - View code statistics and overview
- **query_important_code** - Find most important components
- **search_code** - Search for specific code entities
- **manage_cache** - Control indexing cache
